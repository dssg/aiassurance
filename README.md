...
* [**Assurance Report Template**](documents/assurance-report-format.pdf): a template for structuring the output of the assurance process, including recommendations for improvements to the system.
...
### Step 2(a): Interview the named individuals.
...
### Step 2(b): Collect additional artifacts.
...
We organize all the information using the [assurance report template](documents/assurance-report-format.pdf).
